...
$n=$_SESSION[qn]+1;
echo "<tr><th><span class=style2>Question ".  $n .": $row[2]</style><hr>";
...
echo "<tr><td><input class='errors' type=submit style='background-color:blue; color:white; border:#0000FF' name=submit value='Get Result'></form>";
echo "</table></table>";
?>
</body >
</html>